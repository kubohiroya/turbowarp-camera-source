...
declare const runtimeCapabilityVersion: 1;
...
export declare function createRuntimeCapability(host: Omit<CameraSourceCapabilityV1, 'version' | 'requireVersion'>): CameraSourceCapabilityV1;
//# sourceMappingURL=runtime-capability.d.ts.map